...
<html lang="en">
  <head>
    ...
    <title>Dyslexiehulp Registreren</title>
  </head>
  <body>
          ...
          <div class="col-12">
            <form>
              <div class="form-group">
                <label for="formGroupGebruikersnaamInput">Gebruikersnaam</label>
              <input type="text" class="form-control" id="formGroupGebruikersnaamInput" placeholder="Example input">
              </div>
              <div class="form-group">
